...
<head>
    ...
    <style>
        ...
        .print-wrapper { width: 21cm; margin: 1cm auto; padding-top: 2px; }
        ...
        ul.custom-list { list-style-type: '✓ '; }
...
<div class="page">
    ...
    <div class="skill-section">
        <div class="skill-title">{{ $guide->title  }}</div>
        <div class="skill-number">Skill Number {{ $guide->skill_number }}</div>
    </div>

    <div class="info-grid">
        <div><strong>Full Name:</strong> &nbsp;</div>
        <div><strong>No ID:</strong> &nbsp;</div>
    ...
    <div class="task-section">
        ...
        <p>{!! $guide->performance_task !!}</p>
    </div>

    @foreach($guide->tasks as $taskGroup)
        <table>
            <thead>
            <tr>
                <th class="text-center" rowspan="2" style="width: 50%">Tasks</th>
                <th class="text-center" colspan="3">Completed</th>
                <th class="text-center" rowspan="2">Observation/ Hints</th>
            </tr>
            <tr>
            ...
            <tbody>
            <tr>
                <td class="category" colspan="5">{{ $taskGroup['title'] }}</td>
            </tr>
