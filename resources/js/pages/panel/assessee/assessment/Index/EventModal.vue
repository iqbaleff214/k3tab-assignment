            ...
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    <div class="flex items-center gap-2">
                        <RadioButton
                            :disabled="selectedEvent?.extendedProps?.detail.status !== 'scheduled'"
                            :model-value="selectedEvent?.extendedProps?.detail?.result" input-id="result_competent" name="result" value="competent" />
                        <label for="result_competent">{{ t('label.competent') }}</label>
                    </div>
                    <div class="flex items-center gap-2">
                        <RadioButton
                            :disabled="selectedEvent?.extendedProps?.detail.status !== 'scheduled'"
                            :model-value="selectedEvent?.extendedProps?.detail?.result" input-id="result_incompetent" name="result" value="not_competent" />
