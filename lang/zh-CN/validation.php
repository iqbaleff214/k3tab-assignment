...
return [
    ...
    */
    ...
    'before_or_equal' => ':attribute 必须在 :date 之前或等于 :date。',
    'between' => [
    ...
    'gt' => [
        ...
        'string' => ':attribute 长度必须超过 :value 个字符。',
    ],
    'gte' => [
    ...
    'lt' => [
        ...
        'string' => ':attribute 长度必须少于 :value 个字符。',
    ],
    'lte' => [
    ...
    'min' => [
        ...
        'string' => ':attribute 长度必须至少有 :min 个字符。',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => '该 :attribute 已出现在数据泄露中。请选择不同的 :attribute。',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | 以下语言行用于将我们的属性占位符（如 "email"）替换为更易读的内容，
    | 例如 "电子邮件地址"。这有助于使我们的消息更具表达性。
    |
    */
